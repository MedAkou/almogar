        ...
        <aside class="ps-widget--account-dashboard">
            <div class="ps-widget__content">
                <ul>
                    ...
                    <li class="{{ request()->is('*/adresses') ? 'active' : '' }}"><a href="{{ route('adresses',['store' => $store ]) }}"><i class="icon-map-marker"></i> {{ __('Address Book') }}</a></li>
                    <li class="{{ request()->is('*/orders') ? 'active' : '' }}"><a href="{{ route('orders',['store' => $store ]) }}"><i class="icon-store"></i> {{ __('My Orders') }}</a></li>
