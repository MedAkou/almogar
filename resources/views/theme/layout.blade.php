...
<<<<<<< HEAD:resources/views/theme/layout.blade.php
<body class="@yield('bodyClass')  @if(Auth::check())  has-logged   @endif" data-auth-id="" data-slug="{{$store}}" data-store-id="{{ \System::currentStoreId() }}">
...
>>>>>>> 607512cea1f2e040d12d5d02f20bc9488db88380:resources/views/theme2/layout.blade.php
